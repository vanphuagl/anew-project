...
const Emoty = () => {
  return (
    <section className='omoty'>
      <div className='emoty__container'>
        <div className='emoty__left'>
          <svg
        ...
        <div className='emoty__right'>
          <h2>One mile, One thousand years.</h2>
          <p>1,000年先の未来を想像しながら、身の回りから変化を。</p>
        </div>
      </div>
    </section>
  )
